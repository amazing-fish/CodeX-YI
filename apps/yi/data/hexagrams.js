window.__HEXAGRAM_DATA__ = {
        ...
        "3": {
            ...
            "binary": "010001",
            "explanation": "起始维艰",
            "overview": "屯为水雷，象征初始的困难与挑战。屯卦代表事物的初始阶段，充满了不确定性和困难。",
            "detail": "屯卦由坎卦(水)上震卦(雷)下组成，象征云雷交作、万物初生时的艰难。屯卦提醒我们在开始任何事业时都会遇到困难，需要坚持、谨慎和毅力。屯卦教导我们在起步阶段要找到正确的方向，寻求贤能之人的帮助，并且保持耐心。",
            "lines": [
        ...
        "22": {
            ...
            "detail": "贲卦由艮卦(山)上离卦(火)下组成，象征着山下有火，光彩照人。贲原意是装饰美化，引申为文采和礼仪。贲卦告诉我们，适当的装饰和美化能够提升事物的价值和吸引力。但是，装饰应当适度，过度的装饰反而会掩盖事物的本质。贲卦提醒我们，外在的形式和内在的实质都很重要，两者应当和谐统一。'饰外扬质'教导我们在注重外表的同时，更要重视内在的品质和实力。",
            "lines": [
        ...
        "46": {
            ...
            "detail": "升卦由坤卦(地)上巽卦(风)下组成，象征地中生木，万物生长向上。升原意是上升，引申为提升和发展。升卦告诉我们，上升和发展是一个循序渐进的过程，需要脚踏实地，一步一步来。同时，上升也需要得到上级的认可和支持，需要有适当的方法和策略。升卦提醒我们，上升的过程中要保持谦虚和柔顺的态度，不要因为一时的成功而变得骄傲。升卦的'柔顺谦虚'教导我们，真正的上升不是强行攀爬，而是通过自身的价值和贡献得到认可和提升。",
            "lines": [
